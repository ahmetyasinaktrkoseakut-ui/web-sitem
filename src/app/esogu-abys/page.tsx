        ...
        <div className="space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-zinc-400 text-sm">
              Akreditasyon ve Süreç Yönetim Bilgi Sistemi
            </p>
          </div>
            ...
            <ThreeDCard className="premium-card rounded-2xl overflow-hidden">
              ...
              <div className="p-6 sm:p-8 space-y-6">
                ...
                <div className="space-y-3 pt-2 border-t border-white/[0.06]">
                  <h3 className="font-mono text-xs text-zinc-500 uppercase tracking-wider">// Öne Çıkan Özellikler</h3>
                  <ul className="space-y-2.5 text-xs sm:text-sm text-zinc-300">
                    <li className="flex items-center gap-2.5 p-3 rounded-lg bg-zinc-950/40 border border-white/[0.04]">
                      <ShieldCheck className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                      <span>Yüksek Performanslı ve Güvenli Kurumsal Veri Tabanı Altyapısı</span>
                    </li>
                    <li className="flex items-center gap-2.5 p-3 rounded-lg bg-zinc-950/40 border border-white/[0.04]">
                      <Sparkles className="w-4 h-4 text-blue-400 flex-shrink-0" />
                      <span>Kalite ve Akreditasyon Kriterlerinin Otomatik Raporlanması</span>
                    </li>
                  </ul>
                </div>
              </div>
